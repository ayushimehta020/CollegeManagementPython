...
txtnm.grid(row=1, column=2, pady=(30, 10), padx=10, columnspan=2)
...
cmbsem.grid(row=3, column=2, pady=(0, 10), padx=10, columnspan=2)
...
dtDob.grid(row=4, column=2, pady=(0, 10), padx=10, columnspan=2)

CTkLabel(frm, text="Enter Mobile Number").grid(row=5, column=1, padx=12, pady=(0, 10))
txtnm = CTkEntry(frm, width=220)
txtnm.grid(row=5, column=2, pady=(0, 10), padx=10, columnspan=2)

# Age, Gender, Address
CTkLabel(frm, text="Enter Age").grid(row=6, column=1, padx=12, pady=(0, 10))
txtnm = CTkEntry(frm, width=220)
txtnm.grid(row=6, column=2, pady=(0, 10), padx=10, columnspan=2)

CTkLabel(frm, text="Select Gender").grid(row=7, column=1, pady=(0, 10))
...
rbMale.grid(row=7, column=2, pady=(0, 10))
...
rbFemale.grid(row=7, column=3, pady=(0, 10))

CTkLabel(frm, text="Enter Address").grid(row=8, column=1, padx=12, pady=(0, 10))
...
Result.place(x=228, y=300)
 
Scroll = tkinter.Scrollbar(frm,command=Result.yview)
Scroll.grid(row=8,column=3,padx=12,sticky='NS')
Result.config(yscrollcommand=Scroll.set)

CTkButton(frm, text="Insert", width=200).grid(row=9, column=1, padx=(12, 6), pady=(30, 20))
CTkButton(frm, text="Clear", width=200).grid(row=9, column=2, padx=6, pady=(30, 20), columnspan=2)
